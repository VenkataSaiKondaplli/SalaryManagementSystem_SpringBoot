...
<div class="background-image"></div>
  ...
  <div class="container">
    <form action="/trasferamount" method="post">
      <h2 style="color:red" align="center">Transfer</h2>
      <h3 style="color:red" align="center">${errorAcount}</h3>
      ...
      <label for="sub1">Target Account Number:</label>
      <input type="text" id="sub1" name="targetacNumber" required><br><br>
